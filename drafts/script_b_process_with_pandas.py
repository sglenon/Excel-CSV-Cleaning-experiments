...
def process_table_with_pandas(input_file: str, boundaries_json_path: str, final_excel_path: str, final_csv_path: str):
    ...
    #print("  [Clean] Dropped rows with any NaN values in step 2.")
    
    # Virtually unmerge headers using forward-fill (proven to work correctly)
    header_df.ffill(axis=1, inplace=True)

    # Create correct and unique header names (proven logic)
    new_columns_raw = []
